...
export class KitchenService {
  ...
  private _status   = signal<KitchenStatus>(MOCK_STATUS);
  ...
  /** Call once on app start. Silently falls back to mock on error. */
  ...
  /** Notify user when kitchen opens. Pass mobile + optional userId. */
